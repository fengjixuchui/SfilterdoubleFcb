...
typedef struct _TAGPFPFCB
{
	...
	//当非可信进程要求写的时候，判断为false，那么返回 说明这个文件正在编辑，以只读方式打开？？？
...
NTSTATUS PfpGetFullPathPreCreate_ForVirtulZip(
	PIRP pIrp,
